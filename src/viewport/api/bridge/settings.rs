...
impl ViewerSettingsState {
    ...
    pub(in crate::viewport) fn section_box_enabled(&self) -> bool {
        self.0.section_box.enabled
    }

    pub(in crate::viewport) fn set_section_box_enabled(&mut self, enabled: bool) {
