...
mod tests {
    ...
    fn disconnect_produces_internal_close_and_handles_queue_saturation() {
        ...
        // Fill normal request queue to capacity
        for i in 0..crate::application::MAX_PENDING_MESSAGES {
        ...
        // Disconnect emits control Close despite full normal queue
