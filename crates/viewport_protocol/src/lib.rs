...
pub use viewport::{
    ...
    BimPropertyGroupId, BimPropertyGroupReadModel, BimPropertyMutation, BimPropertyNameMatch,
    ...
    MAX_BIM_CLASSIFICATION_PAGE_SIZE, MAX_BIM_FIELD_KEY_BYTES, MAX_BIM_REGEX_BYTES,
